...
const library: LibraryItem[] = [
  ...
  { id: 'i.zed',           kind: 'tool', title: 'Zed',
    summary: 'High-performance native editor with built-in Claude integration and seamless remote session handoff.',
    tags: ['ide'],               pinned: false, addedAt: L(0),  toolCategory: 'ide',       cost: 'free',         owned: false },
